...
- Installation location:  **`~/.config/lazyman/Lamia`**
...
- [gennaro-tedesco/nvim-jqx](https://github.com/gennaro-tedesco/nvim-jqx.git){:target="_blank"}{:rel="noopener noreferrer"}
